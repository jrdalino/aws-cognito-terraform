...
allowed_oauth_flows                  = ["code"] #  What do I choose? ["code", "implicit", "client_credentials"]
allowed_oauth_scopes                 = ["email", "openid", "aws.cognito.signin.user.admin", "profile"] # What do i choose? ["phone", "email", "openid", "aws.cognito.signin.user.admin", "profile"]
